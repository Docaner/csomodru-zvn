...
Скачайте серверные файлы сборки по следующему адресу https://drive.google.com/file/d/1SwTPH_YLUzC8wfT4H7Lo7v0L0tckazEH/view?usp=sharing . Обратите внимание, что все последующие пути файлов и папок в этом пункте будут обращены касательно архива из ссылки.
