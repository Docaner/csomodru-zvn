...
//Уникальный ключ
new const g_qstKey[] =          "killhm_50";
//Название
new const g_qstName[] =         "Потроши их!"; 
//Описание
new const g_qstDesc[] =         "Убейте определёное количество^nлюдей, во время режима 50 на 50"
//Категория
...
public plugin_init()
{
    register_plugin("[QST] Kill HM 50/50", "1.0", "Docaner");
