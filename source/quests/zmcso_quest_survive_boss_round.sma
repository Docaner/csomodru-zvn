...
//Уникальный ключ
new const g_qstKey[] =          "survive_boss_round";
//Название
new const g_qstName[] =         "Время охоты..."; 
//Описание
new const g_qstDesc[] =         "Выиграть раунд босса,^n играя за него"
//Категория
...
public plugin_init()
{
    register_plugin("[QST] Survive as Boss", "1.0", "Docaner");
...
public zp_round_ended(eWinTeam)
{
    switch(eWinTeam)
    {
        case WIN_ZOMBIES:
        {
            ...
            {
                if(!is_user_alive(iPlayer) || !zp_get_user_nemesis(iPlayer))
                    continue;
