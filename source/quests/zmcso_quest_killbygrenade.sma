...
//Уникальный ключ
new const g_qstKey[] =          "killbygrenade";
//Название
new const g_qstName[] =         "Взрывное убийство"; 
//Описание
new const g_qstDesc[] =         "Убейте определёное количество^nзомби гранатами"
//Категория
...
public plugin_init()
{
    register_plugin("[QST] Kill by grenade", "1.0", "Docaner");
...
{
    if(!zp_get_user_zombie(pVictim) || ~get_member(pVictim, m_bitsDamageType) & DMG_GRENADE)
        return;
