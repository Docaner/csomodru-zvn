...
//Уникальный ключ
new const g_qstKey[] =          "killhm_plague";
//Название
new const g_qstName[] =         "Распространение чумы"; 
//Описание
new const g_qstDesc[] =         "Убейте определёное количество^nлюдей, во время чумы"
//Категория
...
public plugin_init()
{
    register_plugin("[QST] Kill HM Plague", "1.0", "Docaner");
