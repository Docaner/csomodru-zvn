...
//Уникальный ключ
new const g_qstKey[] =          "lasthuman";
//Название
new const g_qstName[] =         "Последняя кровь"; 
//Описание
new const g_qstDesc[] =         "Убейте определёное количество^nпоследних людей"
//Категория
...
public plugin_init()
{
    register_plugin("[QST] Last Human", "1.0", "Docaner");
...
{
    if(zp_get_user_zombie(pVictim) || !zp_get_user_last_human(pVictim))
        return;
