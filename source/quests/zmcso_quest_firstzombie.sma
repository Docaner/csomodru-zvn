...
//Уникальный ключ
new const g_qstKey[] =          "firstzm";
//Название
new const g_qstName[] =         "Гадюка живучая"; 
//Описание
new const g_qstDesc[] =         "Убейте определёное количество^nпервых зомби"
//Категория
...
public plugin_init()
{
    register_plugin("[QST] First Zombie", "1.0", "Docaner");
...
{
    if(!zp_get_user_zombie(pVictim) || !zp_get_user_first_zombie(pVictim))
        return;
