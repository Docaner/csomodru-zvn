...
#define SQL_USER 			"u4_afpbLMoGGm" 			// Логин бд
#define SQL_PASSWORD 		"8zM.7u=oce5@WEBBj6kI+lj+" 			// Пароль бд
#define SQL_DATABASE 		"s4_csotest" 			// База данных
...
@db_login_result(iFailState, Handle:hQuery, szError[], iError, szData[])
{
	...
	zpe_set_user_ammokey_wohud(id, SQL_ReadResult(hQuery, SQL_FieldNameToNum(hQuery, "MKey")));
	zpe_set_user_moneykey_wohud(id, SQL_ReadResult(hQuery, SQL_FieldNameToNum(hQuery, "AKey")));
