...
new const g_szClassName[] = {"ML_CHINA_NAME"};			// Название класса 
new const g_szClassInfo[] = {"ML_CHINA_INFO"};			// Описание класса
new const g_szClassModel[] = "zp_br_china";				// Модель класса
new const g_szClassClawModel[] = "claws_china.mdl";		// Модель рук класса
#define CLASS_HEALTH 3850								// Здоровье
...
new const g_szSndAbility[] = "zp_br_cso/zombie/male/chinese_ability.wav"; // Звук способности
...
{
	if(zp_get_user_zombie_class(id) != g_iClass) 
		return;
