...
#define PLUGIN "[KZ] Weapon: FN F2000"
#define VERSION "1.0"
...
#define ANIM_IDLE_TIME 0.067
#define ANIM_SHOOT_TIME 0.886
#define ANIM_RELOAD_TIME 3.34
#define ANIM_DRAW_TIME 0.886

#define WEAPON_KEY 1035
#define WEAPON_CSW CSW_SG552
#define WEAPON_OLD "weapon_sg552"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_f2000"
...
#define WEAPON_NAME "FN F2000"
#define WEAPON_COST 0

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_f2000.mdl"

#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/f2000-1.wav"
#define WEAPON_BODY 19

#define WEAPON_CLIP 30
#define WEAPON_AMMO 90

#define WEAPON_RATE 0.105
#define WEAPON_RATE_EX 0.13
#define WEAPON_RECOIL 0.937
#define WEAPON_DAMAGE 1.4
...
public fw_Weapon_PrimaryAttack(iItem) {
	...
	set_pdata_float(iItem, m_flNextPrimaryAttack, get_pdata_int(iPlayer, m_iFOV, 5) != 90 ? WEAPON_RATE_EX : WEAPON_RATE, 4);
