...
#define PLUGIN "[ZMO] Weapon: Lightning SMG-1"
#define VERSION "1.0"
...
#define ANIM_IDLE_TIME 0.06
#define ANIM_SHOOT_TIME 0.7
#define ANIM_RELOAD_TIME 3.54
#define ANIM_DRAW_TIME 0.89

#define WEAPON_KEY 1008
#define WEAPON_OLD "weapon_ump45"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_watergun"

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_watergun.mdl"
#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/water-1.wav"
#define WEAPON_BODY 25

#define WEAPON_CLIP 40
#define WEAPON_AMMO 100
#define WEAPON_RATE 0.1
// #define WEAPON_RECOIL -1.84, 0.89, 0.175
#define WEAPON_DAMAGE 1.23
...
public plugin_init() {
	...
	g_iItemID = zp_register_extra_item("Watergun", 0, ZP_TEAM_HUMAN);
}
...
public fw_Weapon_PrimaryAttack(iItem) 
{
	...
	*/
	...
	Punchangle(iPlayer, .iVecx = -1.3, .iVecy = random_float(1.45, -1.45), .iVecz = 0.0);
...
public fw_TraceAttack(iVictim, iAttacker, Float:flDamage) 
{
	...
	static iItem; 
	iItem = get_pdata_cbase(iAttacker, m_pActiveItem, 5);
	...
	{
		zp_set_user_flame(iVictim, iAttacker, 0.4)
	}
