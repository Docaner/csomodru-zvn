...
#define PLUGIN "[KZ] Weapon: Dual MP7A1"
#define VERSION "1.0"
...
#define ANIM_IDLE 0
#define ANIM_ATTACK_R 3
#define ANIM_ATTACK_L 4
#define ANIM_RELOAD 1
#define ANIM_DRAW 2

// from model: Frames / FPS
#define ANIM_IDLE_TIME 0.125
#define ANIM_SHOOT_TIME 0.267
#define ANIM_RELOAD_TIME 3.4
#define ANIM_DRAW_TIME 1.3

#define WEAPON_KEY 1029
#define WEAPON_CSW CSW_P90
#define WEAPON_OLD "weapon_p90"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_dmp7a1"
...
#define WEAPON_NAME "Dual MP7A1"
#define WEAPON_COST 0

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_dmp7a1.mdl"
#define WEAPON_MODEL_P "models/zp_br_cso/weapons2/p_dmp7a1.mdl"
#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/dmp7-1.wav"
#define WEAPON_BODY 17

#define WEAPON_CLIP 80
#define WEAPON_AMMO 100

#define WEAPON_RATE 0.1
#define WEAPON_RECOIL 1.1
...
public fw_Weapon_PrimaryAttack(iItem) {
	...
	set_pdata_int(iItem, m_iWeaponState, get_pdata_int(iItem, m_iWeaponState, 4) ? 0 : 1, 4);
	...
	UTIL_SendWeaponAnim(iPlayer, get_pdata_int(iItem, m_iWeaponState, 4) ? ANIM_ATTACK_R : ANIM_ATTACK_L);

	static szAnimation[64];
	switch(get_pdata_int(iItem, m_iWeaponState, 4)) {
		case 0: {
			formatex(szAnimation, charsmax(szAnimation), pev(iPlayer, pev_flags) & FL_DUCKING ? "crouch_shoot_dualpistols" : "ref_shoot_dualpistols");
		}
		case 1: {
			formatex(szAnimation, charsmax(szAnimation), pev(iPlayer, pev_flags) & FL_DUCKING ? "crouch_shoot2_dualpistols" : "ref_shoot2_dualpistols");
		}
	}
