...
#define ANIM_RELOAD_INSERT 3
#define ANIM_RELOAD_END 4
#define ANIM_RELOAD_START 5
#define ANIM_DRAW 6

// from model: Frames / FPS
#define ANIM_IDLE_TIME 0.17
#define ANIM_SHOOT_TIME 0.77
#define ANIM_INSER_TIME 0.47
#define ANIM_START_TIME 0.54
#define ANIM_END_TIME 0.97
#define ANIM_DRAW_TIME 1.03

#define WEAPON_KEY 1026
#define WEAPON_CSW CSW_M3
#define WEAPON_OLD "weapon_m3"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_m1887"
#define WEAPON_HUD "sprites/zp_br_cso/weapons2/hud2/640hud0.spr"
#define WEAPON_HUD_AMMO "sprites/zp_br_cso/weapons2/hud2/ammo1.spr"

#define WEAPON_NAME "M1887"
#define WEAPON_COST 0

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_m1887.mdl"

#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/m1887-1.wav"
#define WEAPON_BODY 7

#define WEAPON_CLIP 8
#define WEAPON_AMMO 32
#define WEAPON_RATE 0.925
#define WEAPON_RECOIL 1.04
#define WEAPON_DAMAGE 1.34
...
public fw_Item_PostFrame(iItem) {
	...
	if(get_pdata_int(iItem, m_fInSpecialReload, 4) == 1) {
		...
		if(iAmmo <= 0 || iClip== WEAPON_CLIP) {
			set_pdata_int(iItem, m_fInSpecialReload, 0, 4);
			set_pdata_float(iItem, m_flNextSecondaryAttack, ANIM_END_TIME, 4);
			set_pdata_float(iItem, m_flTimeWeaponIdle, ANIM_END_TIME, 4);
			...
			set_pdata_float(iItem,m_flNextSecondaryAttack, ANIM_INSER_TIME, 4);
			set_pdata_float(iItem, m_flTimeWeaponIdle, ANIM_INSER_TIME, 4);
...
public fw_Weapon_Reload(iItem) {
	...
	set_pdata_float(iItem, m_flNextPrimaryAttack, ANIM_START_TIME, 4);
	set_pdata_float(iItem, m_flNextSecondaryAttack, ANIM_START_TIME, 4);
	set_pdata_float(iItem, m_flTimeWeaponIdle, ANIM_START_TIME, 4);
	set_pdata_float(iPlayer, m_flNextAttack, ANIM_START_TIME, 5);
