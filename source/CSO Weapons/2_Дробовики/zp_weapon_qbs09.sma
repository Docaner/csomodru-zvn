...
#define PLUGIN "[ZMO] Weapon: QBS-09"
#define VERSION "1.0"
...
#define ANIM_IDLE_TIME 2.03
#define ANIM_RELOAD_TIME 0.7
#define ANIM_DRAW_TIME 1.04
#define ANIM_SHOOT_TIME 1.04

#define WEAPON_KEY 1005
#define WEAPON_OLD "weapon_xm1014"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_qbs09"

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_qbs_09.mdl"

#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_MODEL_S "models/shotgunshell.mdl"
#define WEAPON_SOUND_S "weapons/qbs09-1.wav"
#define WEAPON_BODY 6

#define WEAPON_CLIP 8
#define WEAPON_AMMO 32
#define WEAPON_RATE 0.3
#define WEAPON_RECOIL 0.98
#define WEAPON_DAMAGE 1.22
...
public plugin_init() {
	...
	g_iItemID = zp_register_extra_item("QBS-09", 0, ZP_TEAM_HUMAN);
}
...
public fw_Item_PostFrame(iItem) 
{
	...
	if(get_pdata_int(iItem, m_fInSpecialReload, 4) == 1) 
	{
		...
		else 
		{
			...
			set_pdata_float(iItem,m_flNextSecondaryAttack, 0.67, 4);
			set_pdata_float(iItem, m_flTimeWeaponIdle, 0.67, 4);
