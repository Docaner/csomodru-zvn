...
#define PLUGIN "[KZ] Weapon: USAS12"
#define VERSION "1.0"
...
#define ANIM_IDLE 0
#define ANIM_ATTACK random_num(1,4)
#define ANIM_RELOAD 5
#define ANIM_DRAW 6

// from model: Frames / FPS
#define ANIM_IDLE_TIME 0.125
#define ANIM_SHOOT_TIME 1.25
#define ANIM_RELOAD_TIME 4.54
#define ANIM_DRAW_TIME 0.59

#define WEAPON_KEY 1038
#define WEAPON_CSW CSW_XM1014
#define WEAPON_OLD "weapon_xm1014"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_usas12"
...
#define WEAPON_NAME "USAS-12"
#define WEAPON_COST 0

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_usas12.mdl"

#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/usas-1.wav"
...
#define WEAPON_RECOIL 1.03
#define WEAPON_DAMAGE 1.41
...
public fw_Item_PostFrame(iItem) {
	if(!CustomItem(iItem)) return;
	static iPlayer; iPlayer = get_pdata_cbase(iItem, m_pPlayer, 4);
	if(get_pdata_int(iItem, m_fInSpecialReload, 4) != 2) return;
