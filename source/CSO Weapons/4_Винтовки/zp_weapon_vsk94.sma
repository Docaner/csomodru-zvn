...
#define PLUGIN "[ZMO] Weapon: VSK-94"
#define VERSION "1.0"
...
#define ANIM_IDLE_TIME 0.875
#define ANIM_RELOAD_TIME 3.34
#define ANIM_DRAW_TIME 0.87

#define WEAPON_KEY 1017
#define WEAPON_OLD "weapon_sg550"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_vsk94"

#define WEAPON_MODEL_V "models/zp_br_cso/weapons2/v_vsk94.mdl"

#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/vsk-11.wav"
#define WEAPON_BODY 32

#define WEAPON_CLIP 20
#define WEAPON_AMMO 80
// #define WEAPON_RATE 0.16
#define WEAPON_RATE 0.14
#define WEAPON_RECOIL -0.57, 0.525, 0.055
#define WEAPON_DAMAGE 1.12
...
public plugin_init() {
	...
	g_iItemID = zp_register_extra_item("VSK-94", 0, ZP_TEAM_HUMAN);
}
