...
#define PLUGIN "[KZ] Weapon: Skull-1"
#define VERSION "1.0"
...
#define ANIM_IDLE 0
#define ANIM_ATTACK random_num(2,3)
#define ANIM_ATTACK2 random_num(4,5)
...
#define ANIM_RELOAD_TIME 2.54
#define ANIM_DRAW_TIME 1.03

#define WEAPON_KEY 1040
#define WEAPON_CSW CSW_DEAGLE
#define WEAPON_OLD "weapon_deagle"
#define WEAPON_NEW "zp_br_cso/weapons2/weapon_skull1"
#define WEAPON_HUD "sprites/zp_br_cso/weapons2/hud2/640hud0.spr"
#define WEAPON_HUD_AMMO "sprites/zp_br_cso/weapons2/hud2/ammo2.spr"

#define WEAPON_NAME "Skull-1"
#define WEAPON_COST 0

#define WEAPON_MODEL_V "models/zp_br_cso/weapons3/v_skull1.mdl"

#define WEAPON_MODEL_W "models/zp_br_cso/other/w_weapons_b1.mdl"
#define WEAPON_SOUND_S "weapons/skull1-1.wav"
#define WEAPON_BODY 2

#define WEAPON_CLIP 7
#define WEAPON_AMMO 35

#define WEAPON_RATE 0.17
#define WEAPON_RATE_EX 0.13
#define WEAPON_RECOIL 0.95
#define WEAPON_RECOIL_EX 1.16
#define WEAPON_DAMAGE 1.405
...
public fw_Item_PostFrame(iItem) {
	...
	if(get_pdata_int(iItem, m_fInReload, 4) == 1) {
	...
	else if(iButton & IN_ATTACK2 && get_pdata_float(iItem, m_flNextSecondaryAttack, 4) <= 0.0) {
		if(iClip == 0) {
		...
		vecPunchangle[0] *= WEAPON_RECOIL_EX;
		vecPunchangle[1] *= WEAPON_RECOIL_EX;
		vecPunchangle[2] *= WEAPON_RECOIL_EX;
		set_pev(iPlayer, pev_punchangle, vecPunchangle);

		emit_sound(iPlayer, CHAN_WEAPON, WEAPON_SOUND_S, VOL_NORM, ATTN_NORM, 0, PITCH_NORM);
		UTIL_SendWeaponAnim(iPlayer, ANIM_ATTACK2);

		set_pdata_int(iItem, m_iShellId,  4);
...
public fw_Weapon_PrimaryAttack(iItem) {
	if(pev_valid(iItem) != 2 || !CustomItem(iItem)) return HAM_IGNORED;
	static iPlayer; iPlayer = get_pdata_cbase(iItem, m_pPlayer, 4);
	if(get_pdata_int(iItem, m_iShotsFired, 4) != 0) return HAM_SUPERCEDE;
