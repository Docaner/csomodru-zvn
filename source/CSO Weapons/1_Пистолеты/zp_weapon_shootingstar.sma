...
/* ~ [ Extra Item ] ~ */
new const WEAPON_ITEM_NAME[ ] = 		"Shooting Star";
...
new const WEAPON_MODEL_WORLD[ ] = 		"models/mg/w_firecracker_fix.mdl";
...
new const ENTITY_GRENADE_CLASSNAME[ ] =	"ent_shootstar_missile";
